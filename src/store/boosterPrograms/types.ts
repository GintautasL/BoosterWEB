export enum BoosterProgramActionTypes {
  ...
  DELETE_BOOSTER_PROGRAM_REQUEST = '@@boosterPrograms/DELETE_BOOSTER_PROGRAM_REQUEST',
  DELETE_BOOSTER_PROGRAM_SUCCESS = '@@boosterPrograms/DELETE_BOOSTER_PROGRAM_SUCCESS',
  DELETE_BOOSTER_PROGRAM_FAILURE = '@@boosterPrograms/DELETE_BOOSTER_PROGRAM_FAILURE',
}
